...
const TeamStory = () => {
    ...
    return (
        <section ref={containerRef} className="py-24 bg-[#f5f5f7] w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Label */}
                <p className="text-sm font-bold tracking-wide text-red-500 uppercase mb-2 text-center">Wer steckt dahinter</p>
                <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 font-roboto text-center mb-16 leading-tight">
                ...
                <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-stretch">
                    ...
                    {/* Left — Story Card */}
                    <div ref={leftRef} className="flex-1 bg-white rounded-2xl p-8 md:p-10 shadow-md border border-gray-100 flex flex-col justify-between">
                        <div>
                            {/* Avatars */}
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center text-white font-bold text-xl shadow">H</div>
                                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-white font-bold text-xl shadow">S</div>
                                <div className="ml-2">
                                    <p className="font-bold text-gray-900 text-lg font-roboto">Hanxiang &amp; Simeon</p>
                                    <p className="text-sm text-gray-500">Gründer · Hango Digital</p>
                                </div>
                            </div>

                            {/* Story */}
                            <blockquote className="text-gray-700 text-lg md:text-xl font-inter leading-relaxed border-l-4 border-red-500 pl-5 mb-6">
                        ...
                        <div className="mt-8 flex items-center gap-3">
                            ...
                            <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-600 border border-gray-200">Abschlussklasse 2025</span>
                        </div>
                    </div>
